...
public class WeexYmcFragment extends WeexBaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWXSDKInstance.render("WXSample", WXFileUtils.loadAsset("weex/ymc_index.js", getContext()), null, null, WXRenderStrategy.APPEND_ASYNC);
    }
