...
public class WeexScrollerFragment extends WeexBaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWXSDKInstance.render("WXSample", WXFileUtils.loadAsset("weex/scroller.js", getContext()), null, null, WXRenderStrategy.APPEND_ASYNC);
    }
