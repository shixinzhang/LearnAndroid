...
public class WeexLoadMoreFragment extends WeexBaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWXSDKInstance.render("WXSample", WXFileUtils.loadAsset("weex/load.js", getContext()), null, null, WXRenderStrategy.APPEND_ASYNC);
    }
