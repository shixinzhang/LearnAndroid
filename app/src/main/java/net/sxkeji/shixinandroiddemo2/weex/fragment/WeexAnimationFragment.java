...
public class WeexAnimationFragment extends WeexBaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWXSDKInstance.render("WXSample", WXFileUtils.loadAsset("weex/animation.js", getContext()), null, null, WXRenderStrategy.APPEND_ASYNC);
    }
