...
public class WeexModalFragment extends WeexBaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWXSDKInstance.render("WXSample", WXFileUtils.loadAsset("weex/modal.js", getContext()), null, null, WXRenderStrategy.APPEND_ASYNC);
    }
