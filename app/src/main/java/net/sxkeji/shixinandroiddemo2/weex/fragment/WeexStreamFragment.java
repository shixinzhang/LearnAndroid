...
public class WeexStreamFragment extends WeexBaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWXSDKInstance.render("WXSample", WXFileUtils.loadAsset("weex/stream.js", getContext()), null, null, WXRenderStrategy.APPEND_ASYNC);
    }
