...
public class WeexListFragment extends WeexBaseFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWXSDKInstance.render("WXSample", WXFileUtils.loadAsset("weex/list.js", getContext()), null, null, WXRenderStrategy.APPEND_ASYNC);
    }
