...
/**
 * 测试的首页，后续了解组件化后，在另外一个 module 中新建一个实战的 app
 * <p>
            ...
            new AlertDialog
                    ...
                    .setPositiveButton("是", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            SettingUtils.jumpToSettingAccessibility(TestMainActivity.this);
                        }
                    })
...
//        sendStickyBroadcast();
        ...
        mActivityListAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(TestMainActivity.this, claz);
